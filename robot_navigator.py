...
4. CSV Logging: บันทึกข้อมูลค่าเซนเซอร์และสถานะในแต่ละรอบ (Step/Round)
"""
...
class RobotNavigator:
    ...
    def navigate_path(
        ...
        """
        นำทางหุ่นยนต์ตามรายการพิกัด path จาก BFS พร้อมบันทึกข้อมูลลง CSV ในแต่ละรอบ
        ...
        # บันทึกข้อมูลเริ่มต้น (รอบที่ 0 / Start)
        if self.logger:
        ...
        for step_idx in range(1, len(path)):
            ...
            # 3. บันทึกข้อมูลของรอบนี้ลงใน CSV
            if self.logger:
